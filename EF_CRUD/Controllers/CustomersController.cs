...
namespace EF_CRUD.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            ViewData["NameSortParam"] = String.IsNullOrEmpty(sort) ? "lastName_desc" : "";
            ViewData["CitySortParam"] = sort == "City" ? "city_desc" : "City";
            ...
            customers = sort switch
            {
                ...
                "City" => customers.OrderBy(c => c.City),
                "city_desc" => customers.OrderByDescending(c => c.City),
        ...
        // GET: Customers/Find
        public async Task<IActionResult> Find(string lastName)
        {
            if (lastName == null)
            {
                return NotFound();
            ...
            listOfCustomers.AddRange(_context.Customers);
            var customer = await _context.Customers
                .FirstOrDefaultAsync(m => m.LastName == lastName);

            List<Customer> foundNames = new List<Customer>();
            foreach(Customer name in listOfCustomers)
            {
